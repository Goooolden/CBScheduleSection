...
@interface MyScheduleViewController ()<LTSCalendarEventSource,LTSCalendarScrollViewDelegate>
...
- (void)requestReceiveSchedule:(NSString *)selectedDate {
    [HTTPTool postWithURL:ScheduleMyReceiveURL headers:header(Token) params:getScheduleMyReceiveParam(selectedDate) success:^(id json) {
        if ([json[@"result"] isEqual:@(1)]) {
